...
if (!empty($selectedGenres)) {
    $genreConditions = implode(" OR ", array_fill(0, count($selectedGenres), 'genre LIKE ?'));
    $queryGames .= " AND ($genreConditions)";
    $queryDlc .= " AND ($genreConditions)";
        ...
        <div class="main-content">
            <div class="game-list">
                <?php while ($game = $resultGames->fetch_assoc()): ?>
                    <div class="game-item">
                        <a href="game_details.php?id=<?php echo $game['id']; ?>&type=game" class="game-item">
                            ...
                            <div class="game-info">
                                <div class="game-details">
                                    ...
                                    <p class="game-fact"><?php echo htmlspecialchars($game['genre']); ?></p>
                                    <p class="game-tags"><?php echo htmlspecialchars($game['tags']); ?></p>
                                </div>
                                <div class="game-price">
                                    <p class="game-fact">$<?php echo $game['price']; ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endwhile; ?>
                <?php while ($dlc = $resultDlc->fetch_assoc()): ?>
                    <div class="game-item">
                        <a href="game_details.php?id=<?php echo $dlc['id']; ?>&type=dlc" class="game-item">
                            <img src="data:image/jpeg;base64,<?php echo base64_encode($dlc['main_image']); ?>" alt="<?php echo htmlspecialchars($dlc['title']); ?>">
                            <div class="game-info">
                                <div class="game-details">
                                    <h3><?php echo htmlspecialchars($dlc['title']); ?>, <small><?php echo htmlspecialchars($dlc['type']); ?></small></h3>
                                    <p class="game-fact"><?php echo htmlspecialchars($dlc['genre']); ?></p>
                                    <p class="game-tags"><?php echo htmlspecialchars($dlc['tags']); ?></p>
                                </div>
                                <div class="game-price">
                                    <p class="game-fact">$<?php echo $dlc['price']; ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
